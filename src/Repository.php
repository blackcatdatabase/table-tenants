...
use BlackCat\Database\Packages\Tenants\Repository\TenantRepositoryInterface;
use BlackCat\Database\Packages\Tenants\Repository\TenantRepository as GeneratedRepository;
...
final class Repository
{
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof TenantRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected TenantRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Tenants\Dto\TenantDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Tenants\Dto\TenantDto|null { return $this->repo->getById($id, $asDto); }
