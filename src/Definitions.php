...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'tenants'; }
    public static function contractView(): string { return 'vw_tenants'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'slug', 'slug_ci', 'status', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ]; }
